...
//! Project version number for NYPLAudiobookToolkit.
FOUNDATION_EXPORT double NYPLAudiobookToolkitVersionNumber;
...
FOUNDATION_EXPORT NSString *const FeedbookDRMCertificateTag;
